    ...
    <div className="space-y-3">
      ...
      {showCropChoice && pendingFile && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6 max-h-[85dvh] overflow-y-auto">
      ...
      {selectedImage && uploadType === "slider" && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-xl w-[90%] max-w-3xl max-h-[85dvh] overflow-y-auto">
