          ...
          {loading ? (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-gray-600 whitespace-nowrap">
                    Player
                  </th>
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-gray-600 whitespace-nowrap">
                    Phone
                  ...
                  return (
                    <tr key={i} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 py-2.5 whitespace-nowrap">
                        {typeCfg ? (
                          <span
                            className={`text-xs font-medium px-2 py-0.5 rounded-full ${typeCfg.className}`}
                          >
                            {typeCfg.label}
                          </span>
                        ) : (
