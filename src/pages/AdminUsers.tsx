    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Only Super Admin sees New User button */}
          {isSuperAdmin && (
            <button
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  ...
                  {/* Actions column header — Super Admin only */}
                  {isSuperAdmin && (
        ...
        {deleteTarget && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md animate-modal-in max-h-[85dvh] overflow-y-auto">
              ...
              <div className="p-6">
                <p className="text-slate-700">
                  ...
                  <span className="font-semibold text-slate-900">
                    {deleteTarget.name || deleteTarget.publicId}
                  </span>
                  ?
                </p>
