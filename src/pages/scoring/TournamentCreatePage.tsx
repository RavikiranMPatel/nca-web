    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-24">
      <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base font-semibold text-gray-900 dark:text-white">New Tournament</h1>
        </div>
      </div>
      ...
      <div className="px-4 pt-5 max-w-2xl mx-auto space-y-5">
        ...
        {/* Name */}
        <div>
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Tournament Name *</label>
          <input type="text"
          ...
          <div className="space-y-2">
            {FORMATS.map(f => (
              <button key={f.value} onClick={() => set("format", f.value)}
                ...
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{f.label}</div>
        ...
        {/* Overs */}
        <div>
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Default Overs per Match</label>
          <select className="w-full px-3 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={form.defaultOvers} onChange={e => set("defaultOvers", Number(e.target.value))}>
        ...
        {/* Points */}
        <div>
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Points System</label>
